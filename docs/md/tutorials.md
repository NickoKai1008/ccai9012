...
_Note: These example directions (analysing AI, using AI for analysis, developing AI‑powered tools) are illustrative rather than exhaustive; other directions are also possible, as long as they grow from a well‑framed problem._
